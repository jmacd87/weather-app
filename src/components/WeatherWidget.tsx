...
import { Button, Card, Grid, Container, Typography } from '@mui/material';
    ...
    return (
        <>
            <div style={{ display: "inline-block", marginTop: 20, justifyContent: "center" }}>
                <Button disableRipple sx={city === "Ottawa" ? { ...selected } : { color: 'black', letterSpacing: 1 }} onClick={() => handleClickCity("Ottawa")} >Ottawa</Button>
                <Button disableRipple sx={city === "Moscow" ? { ...selected } : { color: 'black', letterSpacing: 1 }} onClick={() => handleClickCity("Moscow")} >Moscow</Button>
                <Button disableRipple sx={city === "Tokyo" ? { ...selected } : { color: 'black', letterSpacing: 1 }} onClick={() => handleClickCity("Tokyo")} >Tokyo</Button>
            </div>
